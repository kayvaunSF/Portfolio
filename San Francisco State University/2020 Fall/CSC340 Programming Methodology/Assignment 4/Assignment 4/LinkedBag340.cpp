...
helper function: getFrequencyOf340RecursiveHelper. 4 pts
7. IMMEDIATE RECURSION: getFrequencyOf340RecursiveNoHelper recursively counts the number of times an
entry appears in the Linked Bag. This recursive function does not use any helper functions. 8 pts
8. removeRandom340 removes a random entry from the Linked Bag. 4 pts
*/

/**
 * Professor:		Duc Ta
 * Name:			Kayvaun Khoshkhou
 * Due Date:		11/15/2020
 */
